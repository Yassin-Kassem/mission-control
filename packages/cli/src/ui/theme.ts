...
${colors.warning('             ◈')}${colors.dim('──')}${colors.warning('◈')}${colors.dim('─────────────╮  ╭─────────────')}${colors.warning('◈')}${colors.dim('──')}${colors.warning('◈')}
${colors.muted('              ⟍⟋')}${colors.dim('              │  │')}              ${colors.muted('⟍⟋')}
${colors.dim('                        ╭────────╮')}
${colors.dim('                        │')} ${colors.success('■')} ${colors.bright('MCTL')} ${colors.success('■')} ${colors.dim('│')}
${colors.dim('                        ╰────────╯')}
${colors.muted('              ⟋⟍')}${colors.dim('              │  │')}              ${colors.muted('⟋⟍')}
${colors.warning('             ◈')}${colors.dim('──')}${colors.warning('◈')}${colors.dim('─────────────╯  ╰─────────────')}${colors.warning('◈')}${colors.dim('──')}${colors.warning('◈')}
${colors.muted('              ⟍⟋')}                              ${colors.muted('⟍⟋')}
