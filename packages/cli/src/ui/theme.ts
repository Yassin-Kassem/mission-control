...
${colors.dim('                    _____|_____')}
${colors.muted('               ╱───')}${colors.secondary('◉')}${colors.muted('───────────')}${colors.secondary('◉')}${colors.muted('───╲')}
${colors.muted('              ╱    ')}${colors.dim('╔═══════════╗')}${colors.muted('    ╲')}
${colors.muted('        ─────╱     ')}${colors.dim('║')} ${colors.warning('▶')} ${colors.bright('ONLINE')} ${colors.warning('◀')} ${colors.dim('║')}${colors.muted('     ╲─────')}
${colors.muted('       ╱    ╱      ')}${colors.dim('╚═══════════╝')}${colors.muted('      ╲    ╲')}
${colors.warning('    ◇◇◇')}${colors.muted('──╱                               ╲──')}${colors.warning('◇◇◇')}
${colors.warning('    ◇◇◇')}${colors.muted('──╲     ')}${colors.dim('╱╲    ╱╲    ╱╲')}${colors.muted('     ╱──')}${colors.warning('◇◇◇')}
${colors.muted('       ╲    ╲  ')}${colors.dim('╱  ╲  ╱  ╲  ╱  ╲')}${colors.muted('  ╱    ╱')}
${colors.muted('        ─────╲ ')}${colors.dim('▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔')}${colors.muted(' ╱─────')}
${colors.dim('                ╲═══════════════╱')}
${colors.dim('                  ╲_____▼_____╱')}
